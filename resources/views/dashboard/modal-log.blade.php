        ...
        <div class="timeline-centered timeline-sm">
            ...
            <article class="timeline-entry left-aligned">
                <div class="timeline-entry-inner">
                    ...
                    <div class="timeline-icon bg-info"><i class="fa fa-group"></i></div>
                    <div class="timeline-label bg-info"><h4 class="timeline-title">Job Meeting</h4>
            ...
            <article class="timeline-entry">
                <div class="timeline-entry-inner">
                    ...
                    <div class="timeline-icon bg-primary"><i class="fa fa-paper-plane"></i></div>
                    <div class="timeline-label bg-primary"><h4 class="timeline-title">Daily Feeds</h4>
...
<script>
	$(function(){
		$('.modal-body').css('background-color', '#eeeee');
		$('.modal-header').css('background-color', '#eeeee');
	});
</script>
